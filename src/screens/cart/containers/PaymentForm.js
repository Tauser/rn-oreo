...
import {countrySelector, configsSelector, languageSelector} from 'src/modules/common/selectors';
...
function PaymentForm(props) {
  ...
  const {shipping, customerNote, onChangeNote, country, configs, language} = props;
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate(mainStack.page, {
