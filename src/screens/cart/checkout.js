...
import {StyleSheet, View, KeyboardAvoidingView, FlatList, Dimensions, Platform} from 'react-native';
...
function CheckoutScreen(props) {
  ...
  return (
    <ThemedView isFullView>
      ...
      <KeyboardAvoidingView behavior="padding" style={styles.keyboard} enabled={Platform.OS === 'ios'}>
        <FlatList
          extraData={params}
          data={steps}
          horizontal
